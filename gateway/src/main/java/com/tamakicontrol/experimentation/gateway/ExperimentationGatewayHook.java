package com.tamakicontrol.experimentation.gateway;
 ...
 */
public class ExperimentationGatewayHook extends AbstractGatewayModuleHook {
    /**
    ...
    public void startup(LicenseState activationState) {
        logger.info("EXPERIMENTATION BEGUN!!!!!");
    }
