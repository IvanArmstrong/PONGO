...
val sdk_version by extra("8.1.52")
...
ignitionModule {
     ...
     */
    hooks.putAll(mapOf(
        "com.tamakicontrol.experimentation.gateway.ExperimentationGatewayHook" to "G",
        "com.tamakicontrol.experimentation.client.ExperimentationClientHook" to "C",
        "com.tamakicontrol.experimentation.designer.ExperimentationDesignerHook" to "D"
    ))
